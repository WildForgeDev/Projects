class Transaction:
    ...
    def loadTransaction(self):
        self.setAmount(float(input("Enter the transaction amount(DD.CC),$")))
        self.setCode(input("Enter the transaction code('W' or 'D'),"))
        self.setNote(input("Enter the purpose of transaction"))